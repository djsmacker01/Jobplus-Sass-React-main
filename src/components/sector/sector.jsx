      ...
      <div className="sector__types">
        <div className="sector__wrap">
          <picture className="sector__picture">
            <source src={TechBig} media="(min-width: 767px)" />
            <source src={TechSmall} />
        ...
        <div className="sector__wrap">
          <picture className="sector__picture">
            <source src={EngBig} media="(min-width: 767px)" />
            <source src={EngSmall} />
        ...
        <div className="sector__wrap">
          <picture className="sector__picture">
            <source src={HealthBig} media="(min-width: 767px)" />
            <source src={HealthSmall} />
